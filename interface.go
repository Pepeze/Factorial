...
func drawInterface(randomParagraph CleanParagraph, paragraphArray []CleanParagraph) {
	screenWidth := 1920
	screenHeight := 1080
	...
	fileNameLabel := widget.NewLabel(randomParagraph.FileName)
	...
	paragraphLabel := widget.NewLabel(randomParagraph.Text)
	...
	refreshButton := widget.NewButton("Refresh", func() {
		...
		paragraphLabel.SetText(randomParagraph.Text)
